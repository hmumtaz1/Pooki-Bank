...
function getAccounts(id){
    $.ajax({
        url: "http://localhost:8484/api/get-accounts",
        type: "POST",
        dataType: 'json',
    ...
    function getUsername(id){
        $.ajax({
            url: "http://localhost:8484/api/get-username",
            type: "POST",
            dataType: 'json',
            contentType: "application/json",
            data: JSON.stringify({user_id: id}),
    ...
    function checkBalance(account){
        $.ajax({
            url: "http://localhost:8484/api/check-balance",
            type: "POST",
            dataType: 'json',
            contentType: "application/json",
            data: JSON.stringify({account_id: account}),
            success: function(data){
                console.log(data);
            },
            error: function (xhr, status, error) {
    ...
    function checkAccountStatus(account){
        $.ajax({
            url: "http://localhost:8484/api/check-account",
            type: "POST",
            dataType: 'json',
            contentType: "application/json",
            data: JSON.stringify({account_id: account}),
    ...
    /* Transfer amount */
    function transferAmount(account,amount,sender){
        $.ajax({
            url: "http://localhost:8484/api/transfer",
            type: "POST",
            dataType: 'json',
            contentType: "application/json",
            data: JSON.stringify({account_id: account, transfer_amount: amount, sender_id: sender}),
            success: function(data){
                console.log(data);
            },
            error: function (xhr, status, error) {
